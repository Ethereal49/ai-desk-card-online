...
For a non-sensitive concern, open a repository issue and identify it as a Code
of Conduct matter. For a confidential report, use GitHub's private
[Report a vulnerability](https://github.com/Ethereal49/ai-desk-card-online/security/advisories/new)
form and prefix the title with `[Code of Conduct]`. Do not include sensitive
conduct reports in public issues.
